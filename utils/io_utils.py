...
def save_output(file_stem: str, image_paths: List[str], ground_truth: str, message: HumanMessage, events: List[Dict[str, Any]], output_dir: Path,
                encoder_cls=None):
    output_data = {"id": file_stem, "image_paths": image_paths, "ground_truth": ground_truth, "message": message, "events": events}
